...
import { Pencil, Users, UserPlus, GitBranch } from "lucide-react";
...
export function MemberProfile({ member, clanId }: MemberProfileProps) {
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <Link href={`/dashboard/clans/${clanId}/members/new?spouseId=${member.id}`}>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <Link href={`/dashboard/clans/${clanId}/members/new?parentId=${member.id}`}>
              <Button variant="ghost" size="sm" className="mt-2 w-full">
                <UserPlus className="h-4 w-4 mr-1" /> Thêm
              </Button>
            </Link>
